...
public class BirthdayService {
	...
	private void sendMessage(SmtpMessageSender smtpMessageSender, String subject, String body, String recipient) throws AddressException, MessagingException {
		...
		Message msg = constructMessage(subject, body, recipient, session);

		// Send the message
		Transport.send(msg);
	}

	private Message constructMessage(String subject, String body, String recipient, Session session) throws MessagingException {
